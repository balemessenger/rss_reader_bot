from sqlalchemy import Column, Integer, String, DateTime, Boolean, TIMESTAMP, Float
...
class RSS(Base):
    ...
    def __init__(self, channel_chat_id, channel_user_name, admin_chat_id, admin_user_name, rss_url, last_updated):
