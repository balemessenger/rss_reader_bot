class BotMessage:
    ...
    enter_channel_id = "آی‌دی کانال خود در بله انتخاب یا وارد کنید.\n" \
                       ...
                       "توجه مهم:\n" \
                       "۱. برای انجام این کار شما باید مالک کانال وارد شده باشید.\n" \
                       "۲. شما باید بازوی @rssreaderbot را به کانال خود اضافه کرده و مدیر کنید."
    help = "با استفاده از این بازو می‌توانید فید سایت‌های دلخواه خود" \
           " را به صورت اتوماتیک در کانال بله‌تان مشاهده کنید.\n" \
           "برای این کار کافی است بازوی @rssreaderbot را در کانال خود درج کرده و آن را مدیر کانال کنید.\n" \
           "سپس از منوی تعریف *فیدخوان* کار را آغاز کنید و نشانی فیدهای مورد نظر خود را وارد کنید.\n\n" \
           "مثالهایی از فیدهای معتبر:\n\n" \
           "سایت آیت‌الله خامنه‌ای: http://farsi.khamenei.ir/rss\n" \
           "سایت خبری فارس نیوز: https://www.farsnews.com/rss\n" \
           "سایت خبری عصر ایران: https://www.asriran.com/fa/rss/1\n" \
           "سایت ورزش ۳: https://www.varzesh3.com/rss/all"
    line = "\n"
